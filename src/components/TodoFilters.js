...
const TodoFilters = () => {
  ...
  return (
    <div className="card-filters row  a">
      <div className="col-sm-3 col-md-3 text-center mt-2 ">
        <p className="btn btn-sm">{`${activeTodos.length} items left`}</p>
      </div>
      ...
      <div className="col-sm-4 col-md-4 text-center mt-2">
